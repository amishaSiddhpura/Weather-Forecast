...
import com.example.weatherforecast.adapters.WeatherRecyclerAdapter;
import com.example.weatherforecast.fragments.AboutDialogFragment;
import com.example.weatherforecast.fragments.AmbiguousLocationDialogFragment;
import com.example.weatherforecast.fragments.RecyclerViewFragment;
import com.example.weatherforecast.models.Weather;
import com.example.weatherforecast.tasks.GenericRequestTask;
import com.example.weatherforecast.tasks.ParseResult;
import com.example.weatherforecast.tasks.TaskOutput;
import com.example.weatherforecast.utils.Formatting;
import com.example.weatherforecast.utils.UI;
import com.example.weatherforecast.utils.UnitConvertor;
import com.example.weatherforecast.widgets.AbstractWidgetProvider;
import com.example.weatherforecast.widgets.DashClockWeatherExtension;
...
import static com.example.weatherforecast.utils.TimeUtils.isDayTime;
...
public class MainActivity extends BaseActivity implements LocationListener {
    ...
    public WeatherRecyclerAdapter getAdapter(int id) {
        ...
        if (id == 0) {
            ...
            weatherRecyclerAdapter = new WeatherRecyclerAdapter(this, longTermAfterTomWeather);
        }
    ...
    private void searchCities() {
        ...
        input.setBackgroundResource(R.drawable.edittext_button_style_rounded);

        input.setMaxLines(1);
        input.setSingleLine(true);
        alert.setView(input, 32, 25, 32, 0);
